...
NEWS_FILE = DATA_DIR / "processed" / "news_keywords.csv"
...
for _, row in topics.iterrows():
    ...
    for topic in canonical_topics:
        ...
        score = max(
            fuzz.token_sort_ratio(clean, topic["clean"]),
            fuzz.token_set_ratio(clean, topic["clean"]),
            fuzz.partial_ratio(clean, topic["clean"])
        )
